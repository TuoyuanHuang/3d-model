const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-dCNfoitj.js","assets/supabase-BZoxqOT3.js","assets/vendor-seEwQDT5.js","assets/router-BnLuTL28.js","assets/ui-CrNHFUv9.js","assets/products-BfWltiH_.js","assets/About-BsRa3Cud.js","assets/Catalog-CiFIMN7v.js","assets/Contact-DqWne9a5.js","assets/ProductDetail-La1uffFb.js","assets/CheckoutForm-DjULdGl1.js","assets/stripe-rSCYVjF0.js","assets/LazyImage-BJzYEW0J.js","assets/Cart-BykI78WL.js","assets/Checkout-DCqCBiUI.js","assets/Orders-BY3Zb1hp.js","assets/OrderDetail-C5pQ7VPC.js","assets/Login-DuxQmxJ5.js","assets/Profile-CjVBx97q.js","assets/AdminLogin-DtKk0cxz.js","assets/AdminSetup-ADNKJvTD.js","assets/AdminDashboard-BcajBHtM.js","assets/PrivacyPolicy-BSt89fPe.js","assets/TermsAndConditions-CAs-AJJT.js"])))=>i.map(i=>d[i]);
import{r as d,d as ye,a as y}from"./vendor-seEwQDT5.js";import{c as be,_ as b}from"./supabase-BZoxqOT3.js";import{u as se,L as h,N as ae,B as je,R as Y,a as g}from"./router-BnLuTL28.js";import{P as oe,S as J,a as Z,b as Q,C as G,L as K,U as ee,X as ve,M as _e,F as we,I as Ne,c as Ee,d as Ce,e as Ae,f as Oe,g as ke}from"./ui-CrNHFUv9.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();var ie={exports:{}},V={};/**
 * @license React
