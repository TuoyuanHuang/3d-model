const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-CPaP9sfR.js","assets/supabase-BZoxqOT3.js","assets/vendor-seEwQDT5.js","assets/router-BnLuTL28.js","assets/ui-BkBIl3wn.js","assets/products-BfWltiH_.js","assets/About-R_CLwUYV.js","assets/Catalog-C3KKGyCG.js","assets/Contact-DCuyx2NG.js","assets/ProductDetail-BBYlmjvA.js","assets/CheckoutForm-QfUfGkZO.js","assets/stripe-rSCYVjF0.js","assets/LazyImage-BUqkiSev.js","assets/Cart-sElGQWVD.js","assets/Checkout-Brjbnar6.js","assets/Orders-YPywvCOO.js","assets/OrderDetail-CwSVACId.js","assets/Login-C5eV9cvx.js","assets/Profile-v6qGjGEI.js","assets/AdminLogin-Bj_qilKX.js","assets/AdminSetup-FneEUu-y.js","assets/AdminDashboard-4s7Dk5kl.js","assets/PrivacyPolicy-Bx7VJm2R.js","assets/TermsAndConditions-B5lFDU9V.js"])))=>i.map(i=>d[i]);
import{r as d,d as ye,a as y}from"./vendor-seEwQDT5.js";import{c as be,_ as b}from"./supabase-BZoxqOT3.js";import{u as se,L as h,N as ae,B as je,R as Y,a as g}from"./router-BnLuTL28.js";import{P as oe,S as J,a as Z,b as Q,C as G,L as K,U as ee,X as ve,M as _e,F as we,I as Ne,c as Ee,d as Ce,e as Ae,f as Oe,g as ke}from"./ui-BkBIl3wn.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();var ie={exports:{}},V={};/**
 * @license React
